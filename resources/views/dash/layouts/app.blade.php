...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        {{-- <a class="dropdown-item" href="{{ route('logoutadminstration') }}" onclick="event.preventDefault(); --}}
                        document.getElementById('logout-form').submit();">
                        {{ __('logoutadminstration') }}
                        </a>
                        {{-- <a href="{{route('logoutadmin')}}">logout</a> --}}

                        {{-- <form id="logout-form" action="{{ route('logoutadminstration') }}" method="POST" class="d-none"> --}}
                        @csrf
                        </form>
                    </div>
                </li>
            ...
            @if (Route::has('login'))
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admins') }}">{{ __('Login') }}</a>
                </li>
            @endif
        ...
        @endguest
        <li><a href="{{route('admins')}}">login admin</a></li>
