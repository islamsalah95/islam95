...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2258055039ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=users">`login`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=products">`login`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=subcategories">`login`.`subcategories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=cart">`login`.`cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=cars">`login`.`cars`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=cartt">`login`.`cartt`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=orderss">`login`.`orderss`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=orders">`login`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=cats">`login`.`cats`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login&table=offers">`login`.`offers`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="37366b786a6f5d4f49512577343e5b2a">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="login" targettable="products">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="login" targettable="cart">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            targetdb="login" targettable="cars">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `login`.`cars` ( `id` BIGINT(20) UNSIGNED NOT NULL ,  `product_id` BIGINT(20) NOT NULL ,  `user_id` BIGINT(20) NOT NULL ,  `quantity` INT(100) NOT NULL ,  `name` VARCHAR(255) NOT NULL ,  `price` DECIMAL(20) NOT NULL ,  `image` VARCHAR(255) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="login" targettable="cart">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cart`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="login" targettable="subcategories">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`  
ORDER BY `products`.`status` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="login" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="login" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
